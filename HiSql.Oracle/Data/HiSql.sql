...
BEGIN
 ...
 || '"MODINAME"  NVARCHAR2 (50)   DEFAULT ''''  '
   ...
   || ') ';
   EXECUTE IMMEDIATE 'ALTER TABLE HI_FIELDMODEL  ADD CONSTRAINT PK_HI_FIELDMODEL_23E0AD76BE7D48B0818F1F7A117B23F2 PRIMARY KEY ("DBNAME","TABNAME" ,"FIELDNAME" )';
...
EXECUTE IMMEDIATE 'INSERT INTO [$Schema$].HI_TABMODEL ("TABNAME","TABRENAME","TABDESCRIPT","TABSTORETYPE","TABTYPE","TABCACHETYPE","TABSTATUS","ISSYS","ISEDIT","ISLOG","LOGTABLE","LOGEXPRIREDAY") VALUES(''HI_TABMODEL'',''HI_TABMODEL'',''表结构信息主表'',''0'',''0'',''0'',''0'',0,1,0,'''',''0'')';
...
EXECUTE IMMEDIATE 'INSERT INTO [$Schema$].HI_TABMODEL ("TABNAME","TABRENAME","TABDESCRIPT","TABSTORETYPE","TABTYPE","TABCACHETYPE","TABSTATUS","ISSYS","ISEDIT","ISLOG","LOGTABLE","LOGEXPRIREDAY") VALUES(''HI_FIELDMODEL'',''HI_FIELDMODEL'',''表结构信息字段表'',''0'',''0'',''0'',''0'',0,1,0,'''',''0'')';
...
EXECUTE IMMEDIATE 'COMMENT ON COLUMN HI_FIELDMODEL.DBNAME  IS ''数据库名''';
