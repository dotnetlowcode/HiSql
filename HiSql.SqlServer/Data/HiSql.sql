...
[TabName],[TabReName],[TabDescript],[TabStoreType],[TabType],[TabCacheType],[TabStatus],[IsSys],[IsEdit],[IsLog],[LogTable],[LogExprireDay]) values('Hi_TabModel','Hi_TabModel','','0','0','0','0',0,1,0,'','0')insert into [[$Schema$]].[Hi_FieldModel] (
...
insert into [[$Schema$]].[Hi_TabModel] (
[TabName],[TabReName],[TabDescript],[TabStoreType],[TabType],[TabCacheType],[TabStatus],[IsSys],[IsEdit],[IsLog],[LogTable],[LogExprireDay]) values('Hi_FieldModel','Hi_FieldModel','','0','0','0','0',0,1,0,'','0')insert into [[$Schema$]].[Hi_FieldModel] (
...
insert into [[$Schema$]].[Hi_TabModel] (
[TabName],[TabReName],[TabDescript],[TabStoreType],[TabType],[TabCacheType],[TabStatus],[IsSys],[IsEdit],[IsLog],[LogTable],[LogExprireDay]) values('Hi_Domain','Hi_Domain','数据域主表','0','0','0','0',0,1,0,'','0')insert into [[$Schema$]].[Hi_FieldModel] (
...
insert into [[$Schema$]].[Hi_TabModel] (
[TabName],[TabReName],[TabDescript],[TabStoreType],[TabType],[TabCacheType],[TabStatus],[IsSys],[IsEdit],[IsLog],[LogTable],[LogExprireDay]) values('Hi_DataElement','Hi_DataElement','数据域明细表','0','0','0','0',0,1,0,'','0')insert into [[$Schema$]].[Hi_FieldModel] (
