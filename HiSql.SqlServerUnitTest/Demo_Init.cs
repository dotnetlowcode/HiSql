...
namespace HiSql.UnitTest
{
    class Demo_Init
    {
        public static HiSqlClient GetSql90Client()
        {
            ...
            HiSqlClient sqlclient = new HiSqlClient(
                     new ConnectionConfig()
                     {
                         ...
                         ConnectionString = "server=192.168.1.90,8433;uid=sa;pwd=Hone@123;database=HoneBI;Encrypt=True; TrustServerCertificate=True;",//; MultipleActiveResultSets = true;
                         User = "tansar",//可以指定登陆用户的帐号
                         SlaveConnectionConfigs = new List<SlaveConnectionConfig> {
                             { new SlaveConnectionConfig{ ConnectionString=" server=192.168.1.90,8433;uid=sa;pwd=Hone@123;database=HoneBI;Encrypt=True; TrustServerCertificate=True;" , Weight=3} },
