...
namespace HiSql
{
    public class PostGreSqlQuery : QueryProvider
    {
        ...
        void checkData()
        {
            ...
            int _idx2 = 0;
            bool _flag = false;
            PostGreSqlDM sqlServerDM = null;
            sqlServerDM = (PostGreSqlDM)Instance.CreateInstance<PostGreSqlDM>($"{Constants.NameSpace}.{this.Context.CurrentConnectionConfig.DbType.ToString()}{DbInterFace.DM.ToString()}");
