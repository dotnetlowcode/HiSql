...
{
    [System.Serializable]
    [HiTable(IsEdit = true, TabName = "H_Test02")]
    public class H_Test02 : StandField
    {
        ...
        [HiColumn(FieldDesc = "描述", FieldType = HiType.NVARCHAR, FieldLen = -1, IsNull = true, SortNum = 5, IsSys = true, DBDefault = HiTypeDBDefault.EMPTY)]
