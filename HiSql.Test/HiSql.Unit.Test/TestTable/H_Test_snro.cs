...
{
    [System.Serializable]
    [HiTable(IsEdit = true, TabName = "H_Test_snro")]
    public class H_Test_snro:StandField
    {
        [HiColumn(FieldDesc = "工号", IsPrimary = true, IsBllKey = true, FieldType = HiType.VARCHAR,FieldLen =20,SNO = "WFNO",SNO_NUM ="1", SortNum = 1, IsSys = false, DBDefault = HiTypeDBDefault.EMPTY)]
        public string UEID
        {
            get; set;
        }
