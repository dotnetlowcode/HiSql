        ...
        public UnitMainTest()
        {
            sqlClient = new HiSqlClient(
                 new ConnectionConfig()
                 {
                     ...
                     ConnectionString = @"Data Source=.\sqlexpress;Initial Catalog=HiSql;Integrated Security=True",//; MultipleActiveResultSets = true;
                                                                                                                   //User="tansar",//可以指定登陆用户的帐号

                     SlaveConnectionConfigs = new List<SlaveConnectionConfig> {
                             { new SlaveConnectionConfig{ ConnectionString=@" Data Source=.\sqlexpress;Initial Catalog=HiSql;Integrated Security=True " , Weight=3} },
