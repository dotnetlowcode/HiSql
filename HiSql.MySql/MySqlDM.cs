...
namespace HiSql
{
    public class MySqlDM : IDM
    {
        ...
        public DBVersion DBVersion()
        {
            ...
            var version = CacheContext.LocalMCahe.GetOrCreate(typeof(MySqlDM).FullName + "_DBVersion", () =>
            {
                ...
                newtabinfo = HiSqlCommProvider.InitTabMaping(_keyname, () =>
                {
                    ...
                    else
                    {
                            ...
                            )
                        {
                            ...
                            var phytabInfo = TabDefinitionToEntity(dts, dbConfig.DbMapping);
                            List<FieldChange> fieldChanges = HiSqlCommProvider.TabToCompare(phytabInfo, tabInfo,DBType.MySql);
