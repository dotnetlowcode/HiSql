...
;
            ...
            */
            ...
            _temp_get_table_schema = new StringBuilder()
                ...
                .AppendLine("       when a.data_type ='bit' then 'bit'  when a.data_type ='tinyint'  then 'bit' ") 
